...
<head>
    <title>ILITE Robotics | First Fuel</title>
    <meta charset="utf-8">
...
=======
            ...
            <div class="containernew">
                ...
                <div class="contentcontent">
                    ...
                    That's why we promote (and provide) healthy meals as part of our long hours working together as a team.
                    <br>
                    <blockquote><b>Parents,</b> in return for your contribution to team fuel, your student will be fed at robotics meetings. Supplying the team with proper fuel is an important group effort, as no student should work as hard as they do on an empty
                        stomach. We aim to provide healthy foods (no sodas) to ensure that students are properly nourished during the season, so please keep the term "brain food" in mind. For our hosted competitions (IROC, FLL, and FTC), we are asking
                        for a parent "grill master" that can work the grill for setup volunteers the Friday before the competition. <b>Please note it is a REQUIREMENT for all team members to supply ONE Meal during the season.</b> However, if you wish
                        to contribute to more meals, it would be greatly appreciated. You are expected to provide food for the whole team, current consisting of 75 students and 15 adults.
                    </blockquote>
