...
<head>
	<title>FTC NoVA Regional | Home</title>
	<meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge" />
	<meta name="keywords" content="" />
	<meta name="description" content="" />

	<link rel="shortcut icon" href="../images/ftcfavicon.ico">
							...
							<div class="home-image-wrap clear">
								<div class="home-image-inner-content">
									...
									<div class="headline-title">
										<h1>Northern Virginia FIRST Tech Challenge Regional</h1>
									</div>
...
<div class="B home__news-container">
		<div class="container">
			...
			<p class="home__section-header white xyz">NEWS <span class style="color: #9e3e39;">&</span> UPDATES</p>
...
<div class="addes">
						...
						Concessions will still be available at the event. Pre-orders for lunch will open closer to the date.
					</div>
				</div><!-- end section -->
			</div>
