        ...
        <div class="nav-container">
          ...
          <div class="nav__link" id="nav__community">
            ...
            <div class="nav__link__wrapper" id="nav__community__wrapper">
              <a class="nav__link__target" href='/community/sponsors.php'>Sponsors</a> <a class="nav__link__target" href='/community/summer-camps.php'>Summer Camps</a>  <a class="nav__link__target" href='/community/outreach.php'>Outreach</a> <a class="nav__link__target" href='/community/hosted.php'>Hosted Events</a>
            </div>
      ...
      <div class="home__wrap">
        <div class="home__banner" id="home__banner">
          <div class="home__banner__text-container">
            ...
            <h3>We are a team founded on the principles of leadership, teamwork, and academic rigor. Through competitions, outreach, and mentorship we passionately advocate for science and technology in our schools, communities, and throughout the world.</h3>
          </div><!--
        ...
        <div id="wrap5">
          ...
          <div class="B home__news-container">
            <div class="container">
              ...
              <p class="home__section-sub-header white">Stay up to date with the competitions, exhibitions, and educational outreach <span class="desktop-break">initiatives that ILITE frequently hosts and participates in.</span></p>
              <div class="clearfix margin_top3"></div>
